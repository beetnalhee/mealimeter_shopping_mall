...
<c:if test="${empty loginMember}">
  <c:set var="message" value="댓글 작성은 로그인 후 가능합니다." scope="request" />
  <c:set var="referer" value="/board/comment.jsp?boardId=${article.boardId}&articleId=${article.articleId}&title=${article.title}" scope="request" />
...
<div id="wrapper">
  ...
  <main id="main">
    ...
    <div id="container">
      ...
      <section id="section">
        <div class="contents">
          <h1 class="board-text">댓글 쓰기</h1>
          <form id="board-write-form" action="/board/comment-action.jsp?articleId=${article.articleId}" method="post">
          <input type="hidden" name="boardId" value="<%=boardId%>">
            ...
            <div class="board-write-group board-write-list">
              ...
              <input class="board-write-text" type="text" name="title" placeholder="[re : ${param.title}]">
            </div>
