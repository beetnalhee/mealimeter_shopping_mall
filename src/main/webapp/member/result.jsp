    ...
    <div id="result-wrap">
      ...
      <fieldset id="result-fieldset">
        <ul id="result-info">
          ...
          <li class="result-list"><span class="result-list-color">우편번호</span> ${member.zipCode}</li>
          <li class="result-list"><span class="result-list-color">상세주소</span> ${member.userAddress}</li>
